...
#if [ ! -x mylinpack_64_3 ]; then
 #   echo "####COMPILING .C###############"
  #  gcc mylinpack.c -O3 -o mylinpack_64_3
   # echo "#######################"
    #echo
fi
...
awk  '$1 ~ /\w/ {print $1}' tmp/tmp_nov_1 > var/number_of_variables_1 
...
awk  '$1 ~ /\w/ {print $1}' tmp/tmp_nov_2 > var/number_of_variables_2 
...
#echo "Просчет с уровнем оптимизации 3"
#awk  '$1 !~ /^[\nrealusersys]/ {print $1}' tmp/tmp_timing_3 > tmp/tmp_nov_3
#awk  '$1 ~ /\w/ {print $1}' tmp/tmp_nov_3 > var/number_of_variables_3 
#awk  '$1 ~ /real/ {print $2}' tmp/tmp_timing_3 > var/real_time_3
#echo "########################"
#echo "###time:###"
#cat var/real_time_3
#echo
#echo "###data:###"
#cat var/number_of_variables_3
#echo "########################"echo "########################"


echo "Plotting results"
python3 paint_plot.py var/real_time_0 var/number_of_variables_0 var/real_time_1 var/number_of_variables_1 var/real_time_2 var/number_of_variables_2 var/
